...
const Third_folding_c = () => {
    ...
    const handleSubmit = async (e) => {
        ...
        if (confirmation) {
            ...
            const folding = {
                "category": "Couvertine 4 plis sans goutte d'eau",
    ...
    return (
        ...
        <div className='folding-page'>
            ...
            <div className='folding-container'>
                ...
                />
                <h2>Couvertine 4 plis sans goutte d'eau</h2>
                    ...
                    <div className='form-content'>
                        ...
                        <div className='form-schema-coiff'>
                            <div className='bib-img-container'>
                                <img src={couvertine3} alt='bavettes' className='couvertine-img' />
                            </div>
...
export default Third_folding_c;